...
export function IconSidebar({
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div
        className="flex h-full flex-col items-center justify-between py-6 px-2 md:px-4 w-[60px] md:w-[76px] bg-[#F3F3EE]"
      >
        {/* Top container */}
        <div className="flex flex-col items-center gap-8">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <div className="relative overflow-hidden rounded-full cursor-pointer hover:opacity-90 transition-opacity w-9 h-9 md:w-11 md:h-11 bg-[#1E9A80]">
